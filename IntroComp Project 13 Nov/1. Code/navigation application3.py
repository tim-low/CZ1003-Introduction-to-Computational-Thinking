...
def main():
    print(ask(screen, "location") + " was entered")

display_map()
iconman()
iconbus()
pygame.display.update()
display_box(screen, "where are you going?")
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if count == 2:    
                ...
                print(dest)
                count = 0 
                distance = (((current[1])-(dest[1]))**2 + ((current[0])-(dest[0]))**2)**0.5
                print(distance)
            if count == 1:
                current = mouse_pos
                print(current)
                count += 1
            if mouse_x > 905 and mouse_y > 500:
                count += 1
        ...
        if mouse_x > 905 and mouse_y > 500:
            iconman2()
        elif mouse_x < 905 and mouse_y < 500:
            iconman()
        if mouse_x > 905 and 400 < mouse_y < 500:
            iconbus2()
        elif mouse_x < 905 and mouse_y < 400:
            iconbus()
