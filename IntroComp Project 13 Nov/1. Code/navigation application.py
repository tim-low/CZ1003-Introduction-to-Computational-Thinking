    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if count == 1:
                ...
                print(current)
                count += 1
            if mouseclick()[0] > 905 and mouseclick()[1] > 500:
                count += 1
            
        if mouseclick()[0] > 905 and mouseclick()[1] > 500:
            iconman2()
        elif mouseclick()[0] < 905 and mouseclick()[1] < 500:
            iconman()
        if mouseclick()[0] > 905 and 400 < mouseclick()[1] < 500:
            iconbus2()
        elif mouseclick()[0] < 905 and mouseclick()[1] < 400:
            iconbus()
